...
| [1601B - Frog Traveler](https://codeforces.com/problemset/problem/1601/B) | 9/11      | 1900           | 线段树优化建图, 对于一个 ai 就是 i 的实点向 `[i,i−ai]` 的虚点连一条边权为 1 的边, 对于一个 bi 就是 i 的虚点向 i+bi 的实点连一条边权为 0 的边。再跑 01bfs<br />或: 注意到每个点只有第一次到是最优的, 双端 bfs, |
